...
const AG_T = {
  ...
  albumPhotos: 'Fotografii',
  albumVideos: 'Clipuri',
  albumPhotosEmpty: 'Nicio fotografie încă',
  albumVideosEmpty: 'Niciun clip încă',
  albumAdd: 'Adaugă',
  ...
  // Extra page (CTA on public booking page → internal sub-page)
  extraPageSection: 'Pagină extra',
  extraPageHint: 'Adaugă un buton pe pagina publică ce duce către o pagină proprie. Conținutul paginii se va putea edita în curând.',
  extraPageEnabled: 'Afișează butonul pe pagină',
  extraPageEnabledHint: 'Comută vizibilitatea pe pagina publică.',
  extraPageTitle: 'Nume buton',
  extraPageTitleHint: 'Textul afișat pe buton și ca titlu al paginii.',
  extraPageTitlePlaceholder: 'ex. Costumații, Galerie privată…',
  extraPageDefaultTitle: 'Mai multe',
  extraPageBackToBooking: '← Înapoi la program',
  extraPageEmptyPublic: 'Pagină goală',
  extraPageEmptyPublicHint: 'Mai trece pe aici — providerul lucrează la conținut.',
  // Extra page editor
  extraPageManage: 'Gestionează pagina',
  extraPageEditorSub: 'Articole afișate clienților pe pagina extra.',
  extraPageItems: 'articole',
  extraPageItemSingular: 'articol',
  ...
  extraPageDeleteConfirm: 'Ștergi acest articol?',
  extraPageMoveUp: 'Sus',
  extraPageMoveDown: 'Jos',
  extraPageError: 'Eroare la încărcare',
  extraPageUnsupported: 'Format neacceptat. Folosește JPEG, PNG sau WebP.',
  extraPageTooLarge: 'Imaginea depășește 10 MB.',
  extraPageQuotaExceeded: 'Nu mai ai spațiu. Șterge ceva și încearcă din nou.',
  extraPageItemLimit: 'Ai atins limita de articole.',
  extraPageUploading: 'Se încarcă…',
  extraPageSaving: 'Se salvează…',
  extraPageSaved: 'Salvat',
  // Page background
