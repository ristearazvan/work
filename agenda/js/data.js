...
const AG_T = {
  ...
  // External link (CTA on public page)
  linkSection: 'Link extern',
  linkHint: 'Buton afișat pe pagina publică ce duce către un URL extern (site, rețele sociale etc.).',
  linkEnabled: 'Afișează linkul pe pagină',
  linkEnabledHint: 'Comută vizibilitatea pe pagina publică.',
  linkLabel: 'Nume buton',
  linkLabelHint: 'Textul afișat clientului. Lasă gol pentru „Deschide".',
  linkLabelPlaceholder: 'Site, OnlyFans, Instagram…',
  linkUrl: 'URL',
  linkUrlHint: 'Trebuie să înceapă cu https:// (sau http://).',
  linkUrlPlaceholder: 'https://exemplu.ro',
  linkInvalidUrl: 'URL invalid. Folosește un link complet care începe cu https://',
  linkOpenLabelFallback: 'Deschide',
  // Page background
